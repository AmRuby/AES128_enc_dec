...
begin
	...
	begin
		if rising_edge(clk) then
            ...
            -- The current state is arranged to: { 0,5,a,f; 4,9,e,3; 8,d,2,7; c,1,6,b; } as Gaj & Chodowiec describe in "FPGA and ASIC Implementations of AES" from Cryptographic Engineering, Çetin Kaya Koç, Springer, 2009.
